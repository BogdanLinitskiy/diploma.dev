...
@section('content')
    <form action="/posts/{{$post['id']}}" method="post" class="col-md-12" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-8">
                ...
                <textarea class="form-control" id="about" name="about" style="resize: none">{{$post['about']}}</textarea>
            </div>
            ...
            <div class="form-group col-md-8">
                ...
                <input type ="text" class="form-control" id="order_details" name="order_details" value="{{$post['order_details']}}">
            </div>
