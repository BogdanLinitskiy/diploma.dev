    ...
    <form action="/seller_profile/{{$seller['id']}}" method="post" class="col-md-12" enctype="multipart/form-data">
        ...
        <div class="form-row" id="div1">
            ...
            <div class="form-group col-md-6" >
                ...
                <input type="text" class="form-control" name="languages" id="languages" value="{{$seller['languages']}}" placeholder="Например, Украинский - Носитель">
            </div>
        </div>
        <div class="form-row" id="div1">
            <div class="col-md-3">
            ...
            <div class="form-group col-md-6" >
                ...
                <input type="text" class="form-control" name="skills" id="skills" value="{{$seller['skills']}}" placeholder="Например, вы делайте хороший дизайн логотипов">
            </div>
        </div>
        <div class="form-row" id="div1">
            <div class="col-md-3">
            ...
            <div class="form-group col-md-6" >
                ...
                <input type="text" class="form-control" name="education" id="education" value="{{$seller['education']}}" placeholder="Например, ОНПУ. Кафедра компьютерных интеллектульных систем и сетей">
            </div>
        </div>
        <div class="form-row" id="div1">
            <div class="col-md-3">
        ...
        <div class="form-row" id="div1">
            ...
            <div class="form-group col-md-7" >
                ...
                <textarea class="form-control" name="description" id="description" placeholder="Пожалуйста, расскажите нам о ваших увлечениях, дополнительном опыте, или что либо что вы хотите добавить. (Должно быть не более 500 символов)">{{$seller['description']}}
                </textarea>
            </div>
        </div>
...
@section('jumbotron')
    <div class="jumbotron">
        <div class="container col-md-12">
            <h1 class="display-4 text-center"> Редактирование анкеты </h1>
        </div>
    </div>
@endsection