...
@section('content')
    ...
    <form action="/seller_profile/{{$seller['id']}}" method="post" class="col-md-12" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-3" >
                ...
                <select class="custom-select" id="work" name="work">
                    ...
                    @if($seller['work'] =='full_time')
                        <option value="full_time" selected>Полный рабочий день</option>
                        <option value="part_time">Неполный рабочий день</option>
                    @else
                        <option value="full_time">Полный рабочий день</option>
                        <option value="part_time" selected>Неполный рабочий день</option>
                    @endif
                </select>
            </div>
        </div>
        <div class="form-row" id="div1">
            ...
            <div class="form-group col-md-6" >
                ...
                <input type="text" class="form-control" name="languages" id="languages" maxlength="100" value="{{$seller['languages']}}" placeholder="Например, Украинский - Носитель">
            </div>
        </div>
        <div class="form-row" id="div1">
            <div class="col-md-3">
            ...
            <div class="form-group col-md-6" >
                ...
                <input type="text" class="form-control" name="skills" id="skills" maxlength="100" value="{{$seller['skills']}}" placeholder="Например, вы делайте хороший дизайн логотипов">
            </div>
        </div>
        <div class="form-row" id="div1">
            <div class="col-md-3">
            ...
            <div class="form-group col-md-6" >
                ...
                <input type="text" class="form-control" name="education" id="education" maxlength="100" value="{{$seller['education']}}" placeholder="Например, ОНПУ. Кафедра компьютерных интеллектульных систем и сетей">
            </div>
        </div>
        <div class="form-row" id="div1">
            <div class="col-md-3">
        ...
        <div class="form-row" id="div1">
            ...
            <div class="form-group col-md-7" >
                ...
                <textarea class="form-control" name="description" id="description" maxlength="500" placeholder="Пожалуйста, расскажите нам о ваших увлечениях, дополнительном опыте, или что либо что вы хотите добавить. (Должно быть не более 500 символов)">{{$seller['description']}}
                </textarea>
            </div>
        </div>
...
@section('jumbotron')
    <div class="jumbotron">
        <div class="container col-md-12">
            <h1 class="display-4 text-center"> Редактирование профиля </h1>
        </div>
    </div>
@endsection